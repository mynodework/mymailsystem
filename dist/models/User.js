...
exports.default = function (sequelize, DataTypes) {
    var User = sequelize.define("USER", {
        ...
        user_type: {
            type: DataTypes.ENUM,
            values: ["Admin", "Guest", "HR", "Interviewee"]
        }
    }, {
        hooks: {
        ...
        classMethods: {
            ...
            getInterviewee: function getInterviewee() {
                var _this6 = this;

                return new Promise(function (resolve, reject) {
                    _this6.findAll({ where: { user_type: (0, _constant2.default)().userType.Interviewee }, attributes: ['id', 'email'] }).then(function (response) {
                        resolve(response);
                    });
                });
            }

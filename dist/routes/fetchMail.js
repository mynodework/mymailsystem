...
exports.default = function (app) {
    ...
    app.route("/candidate_notes/insert").post(_auth2.default.requiresAdminHrInterviewee, _fetchEmail2.default.insert_note);

    /*update candidates notes*/
    app.route("/candidate_notes/update").post(_auth2.default.requiresAdminHrInterviewee, _fetchEmail2.default.update_note);
    ...
    /*email tracking*/
    app.route("/track/:email/:tracking_id").get(_fetchEmail2.default.tracking);

    /*email track status*/
    app.route('/fetch/trackingData').get(_auth2.default.requiresAdmin, _fetchEmail2.default.fetchTrackingData);

    /*Add new candidate*/
    app.route('/add/addNewCandidate').post(_auth2.default.requiresAdminOrHr, _fetchEmail2.default.addNewCandidate);

    /*send email to not viewed */
    app.route('/send/sendEmailToNotviewed').put(_auth2.default.requiresAdmin, _fetchEmail2.default.sendEmailToNotviewed);

    /*assign an interviwee*/
    app.route('/assign/interviewee').post(_auth2.default.requiresAdminOrHr, _fetchEmail2.default.assignAnInterviewee);

    /*fetch candidate by interviewee*/
    app.route('/get/candidate/byInterviewee').get(_auth2.default.requiresInterviewee, _fetchEmail2.default.getCandidateByInterviewee);

    /*delete campaign*/
    app.route('/delete/campaign/:campaign_name').delete(_auth2.default.requiresAdmin, _fetchEmail2.default.deleteCampaign);

    /*Route for find emails by tagId*/
    app.param("tag_id", _fetchEmail2.default.findByTagId);

    /*Route to mark a mail to see it later*/
    app.route('/star/starEmail/:star').put(_auth2.default.requiresAdminHrInterviewee, _fetchEmail2.default.starEmail);

    /*Route to view marked mails*/
    app.route('/star/getStaredEmails/').get(_auth2.default.requiresAdminHrInterviewee, _fetchEmail2.default.getStaredEmails);

    /*move mails to archive*/
    app.route('/email/candidateArchive/:email').put(_auth2.default.requiresAdminOrHr, _fetchEmail2.default.candidateArchive);

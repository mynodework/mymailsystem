...
sequelize.sync().then(function () {
    ...
    db.Tag.findOne({ where: { type: (0, _constant2.default)().tagType.default, title: "Shortlist" } }).then(function (id) {
        if (!id) {
            db.Tag.create({ title: "Shortlist", type: (0, _constant2.default)().tagType.default, color: "#cb891b", default_id: 3 });
        }
    });

    db.Tag.findOne({ where: { type: (0, _constant2.default)().tagType.default, title: "Reject" } }).then(function (id) {
        if (!id) {
            db.Tag.create({ title: "Reject", type: (0, _constant2.default)().tagType.default, color: "#ef2e46", default_id: 8 });
        }
    });

    db.Tag.findOne({ where: { type: (0, _constant2.default)().tagType.default, title: "First Round" } }).then(function (id) {
        if (!id) {
            db.Tag.create({ title: "First Round", type: (0, _constant2.default)().tagType.default, color: "#ba21d3", default_id: 4 });
        }
    });
    db.Tag.findOne({ where: { type: (0, _constant2.default)().tagType.default, title: "Second Round" } }).then(function (id) {
        if (!id) {
            db.Tag.create({ title: "Second Round", type: (0, _constant2.default)().tagType.default, color: "#ba21d3", default_id: 5 });
        }
    });
    db.Tag.findOne({ where: { type: (0, _constant2.default)().tagType.default, title: "Third Round" } }).then(function (id) {
        if (!id) {
            db.Tag.create({ title: "Third Round", type: (0, _constant2.default)().tagType.default, color: "#ba21d3", default_id: 6 });
        }
    });
    ...
    db.Tag.findOne({ where: { type: (0, _constant2.default)().tagType.default, title: "Selected" } }).then(function (id) {
        if (!id) {
            db.Tag.create({ title: "Selected", type: (0, _constant2.default)().tagType.default, color: "#ef2f50", default_id: 9 });
        }
    });

    db.Tag.findOne({ where: { type: (0, _constant2.default)().tagType.default, title: "Hold" } }).then(function (id) {
        if (!id) {
            db.Tag.create({ title: "Hold", type: (0, _constant2.default)().tagType.default, color: "#FF0000", default_id: 7 });
        }
    });

    db.Tag.findOne({ where: { type: (0, _constant2.default)().tagType.default, title: "CV Rejected" } }).then(function (id) {
        if (!id) {
            db.Tag.create({ title: "CV Rejected", type: (0, _constant2.default)().tagType.default, color: "#FFE4C4", default_id: 2 });
        }
    });

...
var _candidateHistory = require("./modules/candidateHistory");

var _candidateHistory2 = _interopRequireDefault(_candidateHistory);
...
module.exports = {
    fetchEmail: function fetchEmail(email, logs, spamBox, candidate_history, apiCall) {
                                                                ...
                                                                MailParser(stream).then(function (mail) {
                                                                    _forwardedemail2.default.findEmail(mail).then(function (email_data_to_store) {
                                                                        ...
                                                                        _automaticTags2.default.tags(email, subject, date, from, sender_mail, val.dataValues.email, logs, to, true).then(function (tag) {
                                                                            ...
                                                                            _candidateHistory2.default.checkHistoryMsg(seqno, flag, uid, answered, email_data_to_store, tag, body, attach, email, candidate_history).then(function (historyMsg) {
                                                                                if (!historyMsg) {
                                                                                    email.findOne({
                                                                                        uid: uid,
                                                                                        ...
                                                                                        if (!data) {
                                                                                            _db2.default.SpamList.findOne({ where: { email: sender_mail } }).then(function (spam_contact) {
                                                                                                if (spam_contact) {
                                                                                                    spamBox.findOne({
                                                                                                        uid: uid,
                                                                                                        imap_email: val.dataValues.email
    ...
    beforeDateEmail: function beforeDateEmail(email, logs, spamBox, candidate_history) {
        return new Promise(function (resolve, reject) {
            _db2.default.Imap.findAll({
                where: {
                    "active": true
    ...
    skippedDates: function skippedDates(email, logs, spamBox, candidate_history) {
        return new Promise(function (resolve, reject) {
            var count = void 0;
            _db2.default.Imap.findAll({
                where: {
